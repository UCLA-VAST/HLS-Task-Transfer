...
#pragma HLS array_partition variable=buf_cop complete
...
void pyr_down_accel(class ap_uint< 256 > *img_inp,class ap_uint< 256 > *img_out,int in_rows,int in_cols,int out_rows,int out_cols)
{
...
#pragma HLS stream variable=in_mat.data depth=2
  ...
  p_ZN2xf16Mat_0_256_256_1_C2IEEii_1(&out_mat,out_rows,out_cols);
  ;
