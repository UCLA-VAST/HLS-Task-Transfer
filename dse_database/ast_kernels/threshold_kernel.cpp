...
static void p_ZN2xf17xFThresholdKernelILi0ELi256ELi256ELi0ELi1ELi1ELi1ELi256EEER3MatILi0ELi256ELi256ELi1EER3MatILi0ELi256ELi256ELi1EE7ap_uintILi8EEsstt_1(struct xf_Mat_0_256_256_1_ &_src_mat,struct xf_Mat_0_256_256_1_ &_dst_mat,class ap_uint< 8 > _thresh_type,short _thresh,short maxval,unsigned short height,unsigned short width)
{
  _StreamType_1_name val_src;
  _StreamType_1_name val_dst;
  _PixelType_0_name p;
  _PixelType_0_name thresh = ap_uint< 8> (_thresh);
  class ap_uint< 13 > i;
  class ap_uint< 13 > j;
  class ap_uint< 13 > k;
...
// Standardize from: for(k = 0;k<_ZN13StreamType_1_8bitdepthE;k+=_ZN12PixelType_0_8bitdepthE) {...}
      for (k = 0; k <= 0L; k++) {
        class ap_uint< 13 > _in_k = 0L + 8L * k;
        p = val_src . range((_in_k+(_ZN12PixelType_0_8bitdepthE - 1)),_in_k);
        switch(_thresh_type){
          case (unsigned long )XF_THRESHOLD_TYPE_BINARY:
          val_dst . range((_in_k+(_ZN12PixelType_0_8bitdepthE - 1)),_in_k) = ((p>thresh?ap_uint< 8> (maxval) : ap_uint< 8> (0)));
          break; 
          case (unsigned long )XF_THRESHOLD_TYPE_BINARY_INV:
          val_dst . range((_in_k+(_ZN12PixelType_0_8bitdepthE - 1)),_in_k) = ((p>thresh?ap_uint< 8> (0) : ap_uint< 8> (maxval)));
          break; 
          case (unsigned long )XF_THRESHOLD_TYPE_TRUNC:
          val_dst . range((_in_k+(_ZN12PixelType_0_8bitdepthE - 1)),_in_k) = ((p>thresh?thresh : p));
          break; 
          case (unsigned long )XF_THRESHOLD_TYPE_TOZERO:
          val_dst . range((_in_k+(_ZN12PixelType_0_8bitdepthE - 1)),_in_k) = ((p>thresh?p : ap_uint< 8> (0)));
          break; 
          case (unsigned long )XF_THRESHOLD_TYPE_TOZERO_INV:
          val_dst . range((_in_k+(_ZN12PixelType_0_8bitdepthE - 1)),_in_k) = ((p>thresh?ap_uint< 8> (0) : p));
          break; 
          default:
          val_dst . range((_in_k+(_ZN12PixelType_0_8bitdepthE - 1)),_in_k) = p;
        }
      }
      k = 0L + 8L;
...
static void p_ZN2xf9ThresholdILi0ELi0ELi256ELi256ELi1EEER3MatILi0ELi256ELi256ELi1EER3MatILi0ELi256ELi256ELi1EEss_1(struct xf_Mat_0_256_256_1_ &_src_mat,struct xf_Mat_0_256_256_1_ &_dst_mat,short thresh,short maxval)
{
  ...
  0 == ((int )XF_8UC1) && ((bool )"Type must be XF_8UC1")?((void )0) : __assert_fail("(SRC_T == XF_8UC1) && \"Type must be XF_8UC1\"","xf_threshold.hpp",(unsigned int )132,__PRETTY_FUNCTION__);
  (1 == ((int )XF_NPPC1) || 1 == ((int )XF_NPPC8)) && ((bool )"NPC must be XF_NPPC1, XF_NPPC8")?((void )0) : __assert_fail("((NPC == XF_NPPC1) || (NPC == XF_NPPC8) ) && \"NPC must be XF_NPPC1, XF_NPPC8\"","xf_threshold.hpp",(unsigned int )134,__PRETTY_FUNCTION__);
  (0 == ((int )XF_THRESHOLD_TYPE_BINARY) || 0 == ((int )XF_THRESHOLD_TYPE_BINARY_INV) || 0 == ((int )XF_THRESHOLD_TYPE_TRUNC) || 0 == ((int )XF_THRESHOLD_TYPE_TOZERO) || 0 == ((int )XF_THRESHOLD_TYPE_TOZERO_INV)) && ((bool )"_thresh_type must be either XF_THRESHOLD_TYPE_BINARY or XF_THRESHOLD_TYPE_BINARY or XF_THRESHOLD_TYPE_BINARY_INV or XF_THRESHOLD_TYPE_TRUNC or XF_THRESHOLD_TYPE_TOZERO or XF_THRESHOLD_TYPE_TOZERO_INV")?((void )0) : __assert_fail("((THRESHOLD_TYPE == XF_THRESHOLD_TYPE_BINARY) || (THRESHOLD_TYPE == XF_THRESHOLD_TYPE_BINARY_INV) || (THRESHOLD_TYPE == XF_THRESHOLD_TYPE_TRUNC) || (THRESHOLD_TYPE == XF_THRESHOLD_TYPE_TOZERO) ||(THRESHOLD_TYPE == XF_THRESHOLD_TYPE_TOZERO_INV)) && \"_thresh_type must be either XF_THRESHOLD_TYPE_BINARY or XF_THRESHOLD_TYPE_BINARY or XF_THRESHOLD_TYPE_BINARY_INV or XF_THRESHOLD_TYPE_TRUNC or XF_THRESHOLD_TYPE_TOZERO or XF_THRESHOLD_TYPE_TOZERO_INV\"","xf_threshold.hpp",(unsigned int )138,__PRETTY_FUNCTION__);
  ((int )thresh) >= 0 && ((int )thresh) <= 255 && ((bool )"_binary_thresh_val must be with the range of 0 to 255")?((void )0) : __assert_fail("((thresh >= 0) && (thresh <= 255)) && \"_binary_thresh_val must be with the range of 0 to 255\"","xf_threshold.hpp",(unsigned int )140,__PRETTY_FUNCTION__);
  ((int )height) <= 256 && ((int )width) <= 256 && ((bool )"ROWS and COLS should be greater than input image")?((void )0) : __assert_fail("((height <= ROWS ) && (width <= COLS)) && \"ROWS and COLS should be greater than input image\"","xf_threshold.hpp",(unsigned int )143,__PRETTY_FUNCTION__);
  p_ZN2xf17xFThresholdKernelILi0ELi256ELi256ELi0ELi1ELi1ELi1ELi256EEER3MatILi0ELi256ELi256ELi1EER3MatILi0ELi256ELi256ELi1EE7ap_uintILi8EEsstt_1(_src_mat,_dst_mat,0,thresh,maxval,height,width);
}
...
void threshold_accel(class ap_uint< 256 > *img_inp,class ap_uint< 256 > *img_out,unsigned char thresh,unsigned char maxval,int rows,int cols)
{
...
#pragma HLS DATAFLOW
  ...
  p_ZN2xf9ThresholdILi0ELi0ELi256ELi256ELi1EEER3MatILi0ELi256ELi256ELi1EER3MatILi0ELi256ELi256ELi1EEss_1(in_mat,out_mat,(short )thresh,(short )maxval);
