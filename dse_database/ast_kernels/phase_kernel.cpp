...
static unsigned int p_ZN2xf10DivideYByXEttiiPcPc(unsigned short x,unsigned short y,int M1,int M2,char *out_M,char *out_N)
{
  unsigned int div_val;
  char MOut;
  char NOut;
  unsigned int x_inv = p_ZN2xf7InverseEtiPc(x,M1,&NOut);
  MOut = ((char )(16 - ((int )NOut) + M2));
  NOut = ((char )(((int )NOut) + 16 - M2));
...
static short p_ZN2xf13Atan2LookupFPEssiiii(short xs,short ys,int M1,int N1,int M2,int N2)
{
  N1 == 16 - M1 && N2 == 16 - M2 && M1 == M2 && ((bool )"xs and ys should be of 16-bit and same fixed point type.")?((void )0) : __assert_fail("((N1 == 16-M1) && (N2==16-M2) && (M1==M2)) && \"xs and ys should be of 16-bit and same fixed point type.\"","xf_math.h",(unsigned int )462,__PRETTY_FUNCTION__);
  short theta;
  signed char s1;
  signed char s2;
  signed char s;
  if (((int )ys) == 0 && ((int )xs) == 0) {
    ...
    char MOut;
    char NOut;
    k2_fp = ((unsigned long )(p_ZN2xf10DivideYByXEttiiPcPc((unsigned short )gx_fp,(unsigned short )gy_fp,M1,M2,&MOut,&NOut)));
...
static void p_ZN2xf13xfPhaseKernelILi2ELi2ELi256ELi256ELi3ELi3ELi1ELi5ELi5ELi256EEER3MatILi2ELi256ELi256ELi1EER3MatILi2ELi256ELi256ELi1EER3MatILi2ELi256ELi256ELi1EEiRtRt_1(struct xf_Mat_2_256_256_1_ &_src1,struct xf_Mat_2_256_256_1_ &_src2,struct xf_Mat_2_256_256_1_ &_dst_mat,int _out_format,unsigned short &imgheight,unsigned short &imgwidth)
{
  int M1;
  int N1;
  int M2;
  int N2;
  M1 = 1;
  N1 = _ZN12PixelType_3_8bitdepthE - M1;
  M2 = M1;
  N2 = _ZN12PixelType_3_8bitdepthE - M2;
...
#pragma HLS LOOP_TRIPCOUNT min=256 max=256
      val_src1 = p_ZN2xf16Mat_2_256_256_1_4readIEEi_1(&_src1,(int )((i*imgwidth+j)));
      val_src2 = p_ZN2xf16Mat_2_256_256_1_4readIEEi_1(&_src2,(int )((i*imgwidth+j)));
      int proc_loop = _ZN13StreamType_5_8bitdepthE;
      int step = _ZN12PixelType_3_8bitdepthE;
      procLoop:
// Standardize from: for(class ap_uint< 9 > k(0);k<proc_loop;k+=step) {...}
      for (class ap_uint< 9 > k = 0; k <= 0L; k++) {
        class ap_uint< 9 > _in_k = 0L + 16L * k;
        p = ((short )(val_src1 . range((_in_k+(step - 1)),_in_k)));
        q = ((short )(val_src2 . range((_in_k+(step - 1)),_in_k)));
        ret = p_ZN2xf13Atan2LookupFPEssiiii(p,q,M1,N1,M2,N2);
        if (((int )ret) < 0) {
        ...
        if (_out_format == ((int )XF_DEGREES)) {
          result = ((short )(58671 * result_temp + 0x8000 >> 16));
        }
         else {
          if (_out_format == ((int )XF_RADIANS)) {
            result = ((short )result_temp);
          }
        }
        val_dst . range((_in_k+(step - 1)),_in_k) = ((unsigned long )result);
      }
      p_ZN2xf16Mat_2_256_256_1_5writeIEEi7ap_uintILi16EE_1(&_dst_mat,(int )((i*imgwidth+j)),val_dst);
    }
  }
}

static void p_ZN2xf5phaseILi1ELi2ELi2ELi256ELi256ELi1EEER3MatILi2ELi256ELi256ELi1EER3MatILi2ELi256ELi256ELi1EER3MatILi2ELi256ELi256ELi1EE_1(struct xf_Mat_2_256_256_1_ &_src_matx,struct xf_Mat_2_256_256_1_ &_src_maty,struct xf_Mat_2_256_256_1_ &_dst_mat)
{
  _src_matx . rows <= 256 && _src_matx . cols <= 256 && ((bool )"ROWS and COLS should be greater than input image")?((void )0) : __assert_fail("((_src_matx.rows <= ROWS ) && (_src_matx.cols <= COLS)) && \"ROWS and COLS should be greater than input image\"","xf_phase.hpp",(unsigned int )180,__PRETTY_FUNCTION__);
  _src_maty . rows <= 256 && _src_maty . cols <= 256 && ((bool )"ROWS and COLS should be greater than input image")?((void )0) : __assert_fail("((_src_maty.rows <= ROWS ) && (_src_maty.cols <= COLS)) && \"ROWS and COLS should be greater than input image\"","xf_phase.hpp",(unsigned int )181,__PRETTY_FUNCTION__);
  ...
  p_ZN2xf13xfPhaseKernelILi2ELi2ELi256ELi256ELi3ELi3ELi1ELi5ELi5ELi256EEER3MatILi2ELi256ELi256ELi1EER3MatILi2ELi256ELi256ELi1EER3MatILi2ELi256ELi256ELi1EEiRtRt_1(_src_matx,_src_maty,_dst_mat,1,imgheight,imgwidth);
}
...
#pragma HLS DATAFLOW
  ...
  p_ZN2xf5phaseILi1ELi2ELi2ELi256ELi256ELi1EEER3MatILi2ELi256ELi256ELi1EER3MatILi2ELi256ELi256ELi1EER3MatILi2ELi256ELi256ELi1EE_1(_src1,_src2,_dst);
