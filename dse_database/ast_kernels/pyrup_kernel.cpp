...
static void p_ZN2xf16Mat_0_512_512_1_4initIEEiib_1(struct xf_Mat_0_512_512_1_ *this_,int _rows,int _cols,bool allocate)
{
  
#pragma HLS inline
  _rows > 0 && _rows <= 512 && _cols > 0 && _cols <= 512 && ((bool )"The number of rows and columns must be less than the template arguments.")?((void )0) : __assert_fail("(_rows > 0) && (_rows <= ROWS) && (_cols > 0) && (_cols <= COLS) && \"The number of rows and columns must be less than the template arguments.\"","xf_structs.h",(unsigned int )517,__PRETTY_FUNCTION__);
  this_ -> rows = _rows;
  this_ -> cols = _cols;
  this_ -> size = _rows * (_cols >> _ZN20xfNPixelsPerCycle_1_9datashiftE);
  if (allocate) {
...
static void p_ZN2xf16Mat_0_512_512_1_C2IEEii_1(struct xf_Mat_0_512_512_1_ *this_,int _rows,int _cols)
{
  
#pragma HLS inline
  p_ZN2xf16Mat_0_512_512_1_4initIEEiib_1(this_,_rows,_cols,true);
}
...
static void p_Z18xFPyrUpApplykernelILi1ELi0ELi5ELi25ELi1EEP7ap_uintILi8EEPA5_7ap_uintILi8EE7ap_uintILi8EE_1(_PixelType_0_uname OutputValues[1],_PixelType_0_uname src_buf[5][1 + (5 - 1)],class ap_uint< 8 > win_size)
{
...
#pragma HLS LOOP_TRIPCOUNT min=1 max=5
  ...
  class ap_uint< 5 > _l_i = 0;
  class ap_uint< 5 > _l_k = 0;
// Canonicalized from: for(class ap_uint< 5 > i(0), k(0);i<1;(i ++ ) , k+=8) {...}
  for (_l_i = 0; _l_i <= 0; ++_l_i) {
    ...
    OutputValues[0] . range((_l_k+7),_l_k) = ((unsigned long )((unsigned char )((out_pixel+32>>6) . operator unsigned long())));
    _l_k+=8;
  }
  return ;
}

static void p_Z20xFPyrUpProcessWindowILi512ELi512ELi0ELi1ELi0ELi514ELi5ELi25ELi1EER6streamI7ap_uintILi8EEER6streamI7ap_uintILi8EEEPA512_7ap_uintILi8EEPA5_7ap_uintILi8EEP7ap_uintILi8EER7ap_uintILi8EEttRtP7ap_uintILi13EE7ap_uintILi13EE7ap_uintILi8EE_1(hls::stream< _DataType_0_1_name  > &_src_mat,hls::stream< _DataType_0_1_name  > &_out_mat,_DataType_0_1_name buf[5][512 >> 0],_PixelType_0_uname src_buf[5][1 + (5 - 1)],_PixelType_0_uname OutputValues[1],_PixelType_0_uname &P0,unsigned short img_width,unsigned short img_height,unsigned short &shift_x,class ap_uint< 13 > row_ind[5],class ap_uint< 13 > row,class ap_uint< 8 > win_size)
{
...
#pragma HLS LOOP_TRIPCOUNT min=1 max=514
...
#pragma HLS LOOP_TRIPCOUNT min=1 max=5
    ...
    p_Z18xFPyrUpApplykernelILi1ELi0ELi5ELi25ELi1EEP7ap_uintILi8EEPA5_7ap_uintILi8EE7ap_uintILi8EE_1(OutputValues,src_buf,win_size);
    if (col>=win_size>>1) {
...
static void p_Z21xf_pyrup_gaussian_nxnILi512ELi512ELi0ELi1ELi0ELi514ELi5ELi25ELi1EER6streamI7ap_uintILi8EEER6streamI7ap_uintILi8EEE7ap_uintILi8EEtt_1(hls::stream< _DataType_0_1_name  > &_src_mat,hls::stream< _DataType_0_1_name  > &_out_mat,class ap_uint< 8 > win_size,unsigned short img_height,unsigned short img_width)
{
  ...
  _DataType_0_1_name buf[5][512 >> 0];
...
#pragma HLS LOOP_TRIPCOUNT min=1 max=512
    P0 = 0;
    p_Z20xFPyrUpProcessWindowILi512ELi512ELi0ELi1ELi0ELi514ELi5ELi25ELi1EER6streamI7ap_uintILi8EEER6streamI7ap_uintILi8EEEPA512_7ap_uintILi8EEPA5_7ap_uintILi8EEP7ap_uintILi8EER7ap_uintILi8EEttRtP7ap_uintILi13EE7ap_uintILi13EE7ap_uintILi8EE_1(_src_mat,_out_mat,buf,src_buf,OutputValues,P0,img_width,img_height,shift_x,row_ind,row,win_size);
...
static void p_Z19xFPyrUpGaussianBlurILi512ELi512ELi0ELi1ELi0ELi0ELi5ELi25ELi1EER6streamI7ap_uintILi8EEER6streamI7ap_uintILi8EEE7ap_uintILi8EEitt_1(hls::stream< _DataType_0_1_name  > &_src,hls::stream< _DataType_0_1_name  > &_dst,class ap_uint< 8 > win_size,int _border_type,unsigned short imgheight,unsigned short imgwidth)
{
  ((int )imgheight) <= 512 && ((int )imgwidth) <= 512 && ((bool )"ROWS and COLS should be greater than input image")?((void )0) : __assert_fail("((imgheight <= ROWS ) && (imgwidth <= COLS)) && \"ROWS and COLS should be greater than input image\"","xf_pyr_up_gaussian_blur.hpp",(unsigned int )293,__PRETTY_FUNCTION__);
  win_size<=5 && ((bool )"win_size must not be greater than WIN_SZ")?((void )0) : __assert_fail("(win_size <= WIN_SZ) && \"win_size must not be greater than WIN_SZ\"","xf_pyr_up_gaussian_blur.hpp",(unsigned int )295,__PRETTY_FUNCTION__);
  imgwidth = ((unsigned short )(((int )imgwidth) >> _ZN20xfNPixelsPerCycle_1_9datashiftE));
  p_Z21xf_pyrup_gaussian_nxnILi512ELi512ELi0ELi1ELi0ELi514ELi5ELi25ELi1EER6streamI7ap_uintILi8EEER6streamI7ap_uintILi8EEE7ap_uintILi8EEtt_1(_src,_dst,5,imgheight,imgwidth);
}

static void p_ZN2xf16Mat_0_512_512_1_5writeIEEi7ap_uintILi8EE_1(struct xf_Mat_0_512_512_1_ *this_,int index,_DataType_0_1_name val)
{
  this_ -> data[index] = val;
}

static void p_ZN2xf13xFpyrUpKernelILj256ELj256ELj1ELj0ELi1EEER3MatILi0ELi256ELi256ELi1EER3MatILi0ELi512ELi512ELi1EEtt_1(struct xf_Mat_0_256_256_1_ &_src,struct xf_Mat_0_512_512_1_ &_dst,unsigned short in_rows,unsigned short in_cols)
{
  
#pragma HLS DATAFLOW
  hls::stream< _DataType_0_1_name  > _filter_in;
  hls::stream< _DataType_0_1_name  > _filter_out;
  unsigned short output_height = (unsigned short )(((int )in_rows) << 1);
  unsigned short output_width = (unsigned short )(((int )in_cols) << 1);
  int read_pointer = 0;
  int write_pointer = 0;
...
#pragma ACCEL PARALLEL FACTOR=auto{__PARA__L0}
  for (int i = 0; i < ((int )output_height); i++) {
    
#pragma HLS LOOP_TRIPCOUNT min=1 max=256
    
#pragma ACCEL PARALLEL FACTOR=auto{__PARA__L4}
    for (int j = 0; j < ((int )output_width); j++) {
      
#pragma HLS LOOP_TRIPCOUNT min=1 max=256
      _DataType_0_1_name read_input;
      if (i % 2 == 0 && j % 2 == 0) {
        read_input = p_ZN2xf16Mat_0_256_256_1_4readIEEi_1(&_src,read_pointer);
        read_pointer++;
      }
       else {
        read_input = 0;
  ...
  p_Z19xFPyrUpGaussianBlurILi512ELi512ELi0ELi1ELi0ELi0ELi5ELi25ELi1EER6streamI7ap_uintILi8EEER6streamI7ap_uintILi8EEE7ap_uintILi8EEitt_1(_filter_in,_filter_out,5,(int )XF_BORDER_REPLICATE,output_height,output_width);
...
#pragma HLS LOOP_TRIPCOUNT min=1 max=256
      p_ZN2xf16Mat_0_512_512_1_5writeIEEi7ap_uintILi8EE_1(&_dst,write_pointer,(_filter_out . read()));
      write_pointer++;
    }
  }
  return ;
...
static void p_ZN2xf5pyrUpILi0ELi256ELi256ELi1EEER3MatILi0ELi256ELi256ELi1EER3MatILi0ELi512ELi512ELi1EE_1(struct xf_Mat_0_256_256_1_ &_src,struct xf_Mat_0_512_512_1_ &_dst)
{
  unsigned short input_height = (unsigned short )_src . rows;
  unsigned short input_width = (unsigned short )_src . cols;
  p_ZN2xf13xFpyrUpKernelILj256ELj256ELj1ELj0ELi1EEER3MatILi0ELi256ELi256ELi1EER3MatILi0ELi512ELi512ELi1EEtt_1(_src,_dst,input_height,input_width);
  return ;
}

static _DataType_0_1_name p_ZN2xf16Mat_0_512_512_1_4readIEEi_1(struct xf_Mat_0_512_512_1_ *this_,int index)
{
  return this_ -> data[index];
}

static void p_ZN2xf11accel_utils13xfMat2hlsStrmILi256ELi0ELi512ELi512ELi1ELi262144EEER3MatILi0ELi512ELi512ELi1EER6streamI7ap_uintILi256EEE_1(struct xf_accel_utils *this_,struct xf_Mat_0_512_512_1_ &srcMat,hls::stream< ap_uint< 256 >  > &dstStrm)
{
...
#pragma HLS LOOP_TRIPCOUNT min=1 max=262144
    in = p_ZN2xf16Mat_0_512_512_1_4readIEEi_1(&srcMat,i);
...
static void p_ZN2xf11accel_utils13hlsStrm2ArrayILi256ELi512ELi512ELi1ELi1ELi8ELi8192EEER6streamI7ap_uintILi256EEEP7ap_uintILi256EEii_1(struct xf_accel_utils *this_,hls::stream< ap_uint< 256 >  > &srcStrm,class ap_uint< 256 > *dstPtr,int rows,int cols)
{
  int pixel_width = 1 * 8;
  int loop_count = (rows * cols * pixel_width + 256 - 1) / 256;
...
static void p_ZN2xf11accel_utils11xfMat2ArrayILi256ELi0ELi512ELi512ELi1EEER3MatILi0ELi512ELi512ELi1EEP7ap_uintILi256EE_1(struct xf_accel_utils *this_,struct xf_Mat_0_512_512_1_ &srcMat,class ap_uint< 256 > *dstPtr)
{
...
#pragma HLS DATAFLOW
  ...
  int rows = srcMat . rows;
  int cols = srcMat . cols;
  p_ZN2xf11accel_utils13xfMat2hlsStrmILi256ELi0ELi512ELi512ELi1ELi262144EEER3MatILi0ELi512ELi512ELi1EER6streamI7ap_uintILi256EEE_1(this_,srcMat,strm);
  p_ZN2xf11accel_utils13hlsStrm2ArrayILi256ELi512ELi512ELi1ELi1ELi8ELi8192EEER6streamI7ap_uintILi256EEEP7ap_uintILi256EEii_1(this_,strm,dstPtr,rows,cols);
}

static void p_ZN2xf11xfMat2ArrayILi256ELi0ELi512ELi512ELi1EEER3MatILi0ELi512ELi512ELi1EEP7ap_uintILi256EE_1(struct xf_Mat_0_512_512_1_ &srcMat,class ap_uint< 256 > *dstPtr)
{
  struct xf_accel_utils au;
  p_ZN2xf11accel_utils11xfMat2ArrayILi256ELi0ELi512ELi512ELi1EEER3MatILi0ELi512ELi512ELi1EEP7ap_uintILi256EE_1(&au,srcMat,dstPtr);
}
#pragma ACCEL kernel

void pyr_up_accel(class ap_uint< 256 > *img_inp,class ap_uint< 256 > *img_out,int in_rows,int in_cols,int out_rows,int out_cols)
{
...
#pragma HLS INTERFACE s_axilite port=return bundle=control
  ...
  p_ZN2xf16Mat_0_256_256_1_C2IEEii_1(&in_mat,in_rows,in_cols);
  ;
  
#pragma HLS stream variable=in_mat.data depth=2
  struct xf_Mat_0_512_512_1_ out_mat;
  p_ZN2xf16Mat_0_512_512_1_C2IEEii_1(&out_mat,out_rows,out_cols);
  ;
...
#pragma HLS DATAFLOW
  ...
  p_ZN2xf5pyrUpILi0ELi256ELi256ELi1EEER3MatILi0ELi256ELi256ELi1EER3MatILi0ELi512ELi512ELi1EE_1(in_mat,out_mat);
  p_ZN2xf11xfMat2ArrayILi256ELi0ELi512ELi512ELi1EEER3MatILi0ELi512ELi512ELi1EEP7ap_uintILi256EE_1(out_mat,img_out);
}
