...
static void p_ZN2xf16Mat_1_256_256_1_4initIEEiib_1(struct xf_Mat_1_256_256_1_ *this_,int _rows,int _cols,bool allocate)
{
...
static void p_ZN2xf16Mat_1_256_256_1_C2IEEv_1(struct xf_Mat_1_256_256_1_ *this_)
{
  
#pragma HLS inline
  p_ZN2xf16Mat_1_256_256_1_4initIEEiib_1(this_,256,256,true);
}
...
static void p_ZN2xf16Mat_1_256_256_1_5writeIEEi7ap_uintILi16EE_1(struct xf_Mat_1_256_256_1_ *this_,int index,_DataType_1_1_name val)
{
  this_ -> data[index] = val;
}

static int p_ZN2xf17AddWeightedKernelILi0ELi1ELi256ELi256ELi1ELi1ELi0ELi2ELi1ELi5ELi256EEER3MatILi0ELi256ELi256ELi1EEfR3MatILi0ELi256ELi256ELi1EEffR3MatILi1ELi256ELi256ELi1EEtt_1(struct xf_Mat_0_256_256_1_ &src1,float alpha,struct xf_Mat_0_256_256_1_ &src2,float beta,float gama,struct xf_Mat_1_256_256_1_ &dst,unsigned short height,unsigned short width)
{
  class ap_uint< 13 > i;
  class ap_uint< 13 > j;
  class ap_uint< 13 > k;
  class ap_uint< 13 > l;
  class ap_uint< 24 > temp(alpha * ((float )(1 << 23)));
  class ap_uint< 24 > temp1(beta * ((float )(1 << 23)));
  class ap_uint< 24 > temp2(gama * ((float )(1 << 23)));
  int STEP = _ZN13DataType_0_1_10pixelwidthE / 1;
  _StreamType_5_name pxl_pack_out;
...
#pragma HLS LOOP_TRIPCOUNT min=256 max=256
      ...
      pxl_pack2 = p_ZN2xf16Mat_0_256_256_1_4readIEEi_1(&src2,(int )((i*width+j)));
      l = 0;
      ProcLoop:
// Canonicalized from: for((k = 0) , l = 0;k<(8 << _ZN20xfNPixelsPerCycle_1_9datashiftE) * 1;(k+=8) , l+=16) {...}
// Standardize from: for(k = 0;k <= 7;k += 8) {...}
      for (k = 0; k <= 0L; k++) {
        class ap_uint< 13 > _in_k = 0L + 8L * k;
        _PixelType_0_name pxl1(pxl_pack1 . range((_in_k+7),_in_k));
        _PixelType_0_name pxl2(pxl_pack2 . range((_in_k+7),_in_k));
        class ap_uint< 40 > firstcmp(pxl1*temp);
        class ap_uint< 40 > secondcmp(pxl2*temp1);
        _PixelType_2_name t((firstcmp+secondcmp)+temp2>>23);
        pxl_pack_out . range(((l+16)-1),l) = (t . operator unsigned long());
        l+=16;
      }
      k = 0L + 8L;
      p_ZN2xf16Mat_1_256_256_1_5writeIEEi7ap_uintILi16EE_1(&dst,(int )((i*width+j)),pxl_pack_out);
    }
  }
  return 0;
}

static void p_ZN2xf11addWeightedILi0ELi1ELi256ELi256ELi1EEER3MatILi0ELi256ELi256ELi1EEfR3MatILi0ELi256ELi256ELi1EEffR3MatILi1ELi256ELi256ELi1EE_1(struct xf_Mat_0_256_256_1_ &src1,float alpha,struct xf_Mat_0_256_256_1_ &src2,float beta,float gama,struct xf_Mat_1_256_256_1_ &dst)
{
  0 == ((int )XF_8UC1) && ((bool )"Input TYPE must be XF_8UC1 for 1-channel")?((void )0) : __assert_fail("((SRC_T == XF_8UC1)) && \"Input TYPE must be XF_8UC1 for 1-channel\"","xf_add_weighted.hpp",(unsigned int )105,__PRETTY_FUNCTION__);
  1 == ((int )XF_16UC1) && ((bool )"Output TYPE must be XF_16UC1 for 1-channel ")?((void )0) : __assert_fail("((DST_T == XF_16UC1)) && \"Output TYPE must be XF_16UC1 for 1-channel \"","xf_add_weighted.hpp",(unsigned int )106,__PRETTY_FUNCTION__);
  src1 . rows == src2 . rows && src1 . cols == src2 . cols && ((bool )"Both input images should have same size")?((void )0) : __assert_fail("((src1.rows == src2.rows ) && (src1.cols == src2.cols)) && \"Both input images should have same size\"","xf_add_weighted.hpp",(unsigned int )107,__PRETTY_FUNCTION__);
  src1 . rows == dst . rows && src1 . cols == dst . cols && ((bool )"Input and output image should be of same size")?((void )0) : __assert_fail("((src1.rows == dst.rows ) && (src1.cols == dst.cols)) && \"Input and output image should be of same size\"","xf_add_weighted.hpp",(unsigned int )108,__PRETTY_FUNCTION__);
  src1 . rows <= 256 && src1 . cols <= 256 && ((bool )"ROWS and COLS should be greater than input image")?((void )0) : __assert_fail("((src1.rows <= ROWS ) && (src1.cols <= COLS)) && \"ROWS and COLS should be greater than input image\"","xf_add_weighted.hpp",(unsigned int )109,__PRETTY_FUNCTION__);
  (1 == ((int )XF_NPPC1) || 1 == ((int )XF_NPPC8)) && ((bool )"NPC must be XF_NPPC1, XF_NPPC8 ")?((void )0) : __assert_fail("((NPC == XF_NPPC1) || (NPC == XF_NPPC8) ) && \"NPC must be XF_NPPC1, XF_NPPC8 \"","xf_add_weighted.hpp",(unsigned int )110,__PRETTY_FUNCTION__);
  short width = (short )(src1 . cols >> _ZN20xfNPixelsPerCycle_1_9datashiftE);
  p_ZN2xf17AddWeightedKernelILi0ELi1ELi256ELi256ELi1ELi1ELi0ELi2ELi1ELi5ELi256EEER3MatILi0ELi256ELi256ELi1EEfR3MatILi0ELi256ELi256ELi1EEffR3MatILi1ELi256ELi256ELi1EEtt_1(src1,alpha,src2,beta,gama,dst,(unsigned short )src1 . rows,(unsigned short )width);
}

static _DataType_1_1_name p_ZN2xf16Mat_1_256_256_1_4readIEEi_1(struct xf_Mat_1_256_256_1_ *this_,int index)
{
  return this_ -> data[index];
}
const int _ZN13DataType_1_1_10pixelwidthE = 16;

static void p_ZN2xf11accel_utils13xfMat2hlsStrmILi256ELi1ELi256ELi256ELi1ELi65536EEER3MatILi1ELi256ELi256ELi1EER6streamI7ap_uintILi256EEE_1(struct xf_accel_utils *this_,struct xf_Mat_1_256_256_1_ &srcMat,hls::stream< ap_uint< 256 >  > &dstStrm)
{
  int rows = srcMat . rows;
  int cols = srcMat . cols;
  int loop_count = rows * cols / _ZN20xfNPixelsPerCycle_1_4nppcE;
  int bits_to_add = 256;
  const int N_size = _ZN13DataType_1_1_10pixelwidthE * _ZN20xfNPixelsPerCycle_1_4nppcE;
  class ap_uint< 256 > r;
  _DataType_1_1_name in;
...
#pragma HLS LOOP_TRIPCOUNT min=1 max=65536
    in = p_ZN2xf16Mat_1_256_256_1_4readIEEi_1(&srcMat,i);
...
const int _ZN13DataType_1_1_8bitdepthE = 16;

static void p_ZN2xf11accel_utils11xfMat2ArrayILi256ELi1ELi256ELi256ELi1EEER3MatILi1ELi256ELi256ELi1EEP7ap_uintILi256EE_1(struct xf_accel_utils *this_,struct xf_Mat_1_256_256_1_ &srcMat,class ap_uint< 256 > *dstPtr)
{
...
#pragma HLS DATAFLOW
  ...
  const int ch_width = _ZN13DataType_1_1_8bitdepthE;
  hls::stream< ap_uint< 256 >  > strm;
  int rows = srcMat . rows;
  int cols = srcMat . cols;
  p_ZN2xf11accel_utils13xfMat2hlsStrmILi256ELi1ELi256ELi256ELi1ELi65536EEER3MatILi1ELi256ELi256ELi1EER6streamI7ap_uintILi256EEE_1(this_,srcMat,strm);
...
static void p_ZN2xf11xfMat2ArrayILi256ELi1ELi256ELi256ELi1EEER3MatILi1ELi256ELi256ELi1EEP7ap_uintILi256EE_1(struct xf_Mat_1_256_256_1_ &srcMat,class ap_uint< 256 > *dstPtr)
{
  struct xf_accel_utils au;
  p_ZN2xf11accel_utils11xfMat2ArrayILi256ELi1ELi256ELi256ELi1EEER3MatILi1ELi256ELi256ELi1EEP7ap_uintILi256EE_1(&au,srcMat,dstPtr);
}
#pragma ACCEL kernel

void add_weighted(class ap_uint< 256 > *img_inp1,class ap_uint< 256 > *img_inp2,class ap_uint< 256 > *img_out,int rows,int cols,float alpha,float beta,float gama)
{
...
#pragma HLS INTERFACE s_axilite port=gama bundle=control
...
#pragma HLS stream variable=_src2.data depth=pCOLS/pNPC1
  ...
  p_ZN2xf16Mat_1_256_256_1_C2IEEv_1(&_dst);
  ;
...
#pragma HLS DATAFLOW
  ...
  p_ZN2xf11addWeightedILi0ELi1ELi256ELi256ELi1EEER3MatILi0ELi256ELi256ELi1EEfR3MatILi0ELi256ELi256ELi1EEffR3MatILi1ELi256ELi256ELi1EE_1(_src1,alpha,_src2,beta,gama,_dst);
  p_ZN2xf11xfMat2ArrayILi256ELi1ELi256ELi256ELi1EEER3MatILi1ELi256ELi256ELi1EEP7ap_uintILi256EE_1(_dst,img_out);
}
