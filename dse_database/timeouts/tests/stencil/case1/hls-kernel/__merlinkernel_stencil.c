...
#pragma HLS INLINE OFF
  if (exec == 1) {
    memcpy_wide_bus_read_int_2d_64_512(orig_buf_0,(size_t )0,(size_t )0,(merlin_uint_512 *)orig,(size_t )((c * 2 + r * 64) * 4),sizeof(int ) * ((unsigned long )132),(size_t )132L);
  }
}

static void merlin_memcpy_1(int dst[8192],int dst_idx_0,int src[2],int src_idx_0,unsigned int len,unsigned int max_len)
{
...
void mars_kernel_0_2_node_3_stage_2(int c,int exec,int r,int sol[8192],int sol_buf_0[2])
{
  
#pragma HLS INLINE OFF
  if (exec == 1) {
    merlin_memcpy_1(sol,c * 2 + r * 64,sol_buf_0,0,sizeof(int ) * ((unsigned long )2),8UL);
  }
}

void mars_kernel_0_2_bus(int mars_c,int mars_init,int mars_cond,int filter[9],int mars_filter_buf_0_0[3][3],int mars_filter_buf_0_1[3][3],int *mars_mul_1,merlin_uint_512 orig[512],int mars_orig_buf_0_0[3][64],int mars_orig_buf_0_1[3][64],int mars_r_0,int mars_r_1,int mars_r_2,int sol[8192],int mars_sol_buf_0_1[2],int mars_sol_buf_0_2[2],int *mars_temp_1)
{
...
void mars_kernel_0_2_node_2_stage_1(int c,int exec,int filter_buf_0[3][3],int *mul,int orig_buf_0[3][64],int sol_buf_0[2],int *temp)
{
...
/* Original: #pragma ACCEL TILE FACTOR=1 */
{
/* Original label: stencil_label2:for(c = 0;c < 31;c++) {#pragma ACCEL PIPELINEint orig_buf[3][64];int filter_buf[3][3];int sol_buf[2];memcpy(filter_buf[0],(const void *)(&filter[0]),sizeof(int ) * 9);#pragma HLS array_partition variable=orig_buf cyclic factor = 16 dim=2memcpy_wide_bus_read_int_2d_64_512(orig_buf,0,0,(merlin_uint_512 *)orig,((c * 2 + r * 64) * 4),sizeof(int ) *((unsigned long )132),132L);for(int c_sub = 0;c_sub < 2;++c_sub) {#pragma ACCEL PIPELINE AUTO#pragma ACCEL PARALLEL FACTOR=1temp =((int )0);stencil_label3:for(k1 = 0;k1 < 3;k1++) {#pragma ACCEL PARALLEL COMPLETEstencil_label4:for(k2 = 0;k2 < 3;k2++) {#pragma ACCEL PARALLEL COMPLETEmul = filter_buf[k1][k2] * orig_buf[k1][c_sub + k2];temp += mul;}}sol_buf[c_sub] = temp;}memcpy((void *)(&sol[c * 2 + r * 64]),(const void *)(&sol_buf[0]),sizeof(int ) * 2);} */
    int orig_buf_0[3][64];
...
#pragma HLS array_partition variable=mars_kernel_0_2_orig_buf_0_2 complete dim=1
    ...
    int mars_kernel_0_2_sol_buf_0_0[2];
    int mars_kernel_0_2_sol_buf_0_1[2];
    int mars_kernel_0_2_sol_buf_0_2[2];
    merlinL5:
    for (c = 0; c < 31 + 2; c++) 
/* Original: #pragma ACCEL PIPELINE flatten */
/* Original: #pragma ACCEL TILE FACTOR=2 */
...
{
      if (mars_count_0_2 == 0) 
        mars_kernel_0_2(c,0,30,filter,mars_kernel_0_2_filter_buf_0_0,mars_kernel_0_2_filter_buf_0_1,&mul,orig,mars_kernel_0_2_orig_buf_0_0,mars_kernel_0_2_orig_buf_0_1,mars_kernel_0_2_r_0,mars_kernel_0_2_r_1,mars_kernel_0_2_r_2,sol,mars_kernel_0_2_sol_buf_0_0,mars_kernel_0_2_sol_buf_0_1,&temp);
       else if (mars_count_0_2 == 1) 
        mars_kernel_0_2(c,0,30,filter,mars_kernel_0_2_filter_buf_0_2,mars_kernel_0_2_filter_buf_0_0,&mul,orig,mars_kernel_0_2_orig_buf_0_2,mars_kernel_0_2_orig_buf_0_0,mars_kernel_0_2_r_2,mars_kernel_0_2_r_0,mars_kernel_0_2_r_1,sol,mars_kernel_0_2_sol_buf_0_2,mars_kernel_0_2_sol_buf_0_0,&temp);
       else 
        mars_kernel_0_2(c,0,30,filter,mars_kernel_0_2_filter_buf_0_1,mars_kernel_0_2_filter_buf_0_2,&mul,orig,mars_kernel_0_2_orig_buf_0_1,mars_kernel_0_2_orig_buf_0_2,mars_kernel_0_2_r_1,mars_kernel_0_2_r_2,mars_kernel_0_2_r_0,sol,mars_kernel_0_2_sol_buf_0_1,mars_kernel_0_2_sol_buf_0_2,&temp);
      mars_count_0_2++;
      if (mars_count_0_2 == 3) 
        mars_count_0_2 = 0;
    }
