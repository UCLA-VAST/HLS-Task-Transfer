...
void mars_kernel_0_1_node_0_stage_0(int i,int exec,merlin_uint_512 m1[512],double m1_buf_0[8][64])
{
  
#pragma HLS INLINE OFF
  if (exec == 1) {
    memcpy_wide_bus_read_double_2d_64_512(m1_buf_0,(size_t )0,(size_t )0,(merlin_uint_512 *)m1,(size_t )(i * 512 * 8),sizeof(double ) * ((unsigned long )512),(size_t )512L);
  }
}
...
void mars_kernel_0_1_node_3_stage_2(int i,int exec,merlin_uint_512 prod[512],double prod_buf_0[8][64])
{
  
#pragma HLS INLINE OFF
  if (exec == 1) {
    memcpy_wide_bus_write_double_2d_64_512((merlin_uint_512 *)prod,prod_buf_0,(size_t )0,(size_t )0,(size_t )(8 * (i * 512)),sizeof(double ) * ((unsigned long )512),(size_t )512L);
  }
}

void mars_kernel_0_1_bus(int mars_i,int mars_init,int mars_cond,int *mars_i_col_1,int *mars_k_col_1,merlin_uint_512 m1[512],double mars_m1_buf_0_0[8][64],double mars_m1_buf_0_1[8][64],merlin_uint_512 m2[512],double mars_m2_buf_0_0[64][64],double mars_m2_buf_0_1[64][64],double *mars_mult_1,merlin_uint_512 prod[512],double mars_prod_buf_0_1[8][64],double mars_prod_buf_0_2[8][64])
{
...
void mars_kernel_0_1_node_2_stage_1(int i,int exec,int *i_col,int *k_col,double m1_buf_0[8][64],double m2_buf_0[64][64],double *mult,double prod_buf_0[8][64])
{
...
/* Original: #pragma ACCEL TILE FACTOR=8 */
...
#pragma HLS pipeline
/* Original label: middle:for(j = 0;j < 64;j++) {#pragma ACCEL PARALLEL COMPLETEi_col =(i * 8 + i_sub) * 64;double sum =(double )0;inner:for(k = 0;k < 64;k++) {#pragma ACCEL PARALLEL COMPLETEk_col = k * 64;mult = m1_buf[i_sub][k] * m2_buf[k][j];sum += mult;}prod_buf[i_sub][j] = sum;} */
      merlinL1:
/* Original label: middle:for(j = 0;j < 64;j++) {#pragma ACCEL PARALLEL COMPLETEi_col =(i * 8 + i_sub) * 64;double sum =(double )0;inner:for(k = 0;k < 64;k++) {#pragma ACCEL PARALLEL COMPLETEk_col = k * 64;mult = m1_buf[i_sub][k] * m2_buf[k][j];sum += mult;}prod_buf[i_sub][j] = sum;} */
      for (j = 0; j < 64; j++) 
...
#pragma ACCEL interface variable=m1 depth=4096 max_depth=4096
  ...
  int i_col;
  double mult;
/* Original label: outer:for(i = 0;i < 8;i++) {#pragma ACCEL PIPELINEdouble m2_buf[64][64];double m1_buf[8][64];double prod_buf[8][64];#pragma HLS array_partition variable=m1_buf cyclic factor = 8 dim=2memcpy_wide_bus_read_double_2d_64_512(m1_buf,0,0,(merlin_uint_512 *)m1,(i * 512 * 8),sizeof(double ) *((unsigned long )512),512L);#pragma HLS array_partition variable=m2_buf cyclic factor = 8 dim=2memcpy_wide_bus_read_double_2d_64_512(m2_buf,0,0,(merlin_uint_512 *)m2,(0 * 8),sizeof(double ) *((unsigned long )4096),4096L);for(int i_sub = 0;i_sub < 8;++i_sub) {#pragma ACCEL PIPELINE AUTO#pragma ACCEL PARALLEL FACTOR=1middle:for(j = 0;j < 64;j++) {#pragma ACCEL PARALLEL COMPLETEi_col =(i * 8 + i_sub) * 64;double sum =(double )0;inner:for(k = 0;k < 64;k++) {#pragma ACCEL PARALLEL COMPLETEk_col = k * 64;mult = m1_buf[i_sub][k] * m2_buf[k][j];sum += mult;}prod_buf[i_sub][j] = sum;}}#pragma HLS array_partition variable=prod_buf cyclic factor = 8 dim=2memcpy_wide_bus_write_double_2d_64_512((merlin_uint_512 *)prod,prod_buf,0,0,(8 *(i * 512)),sizeof(double ) *((unsigned long )512),512L);} */
  double m2_buf_0[64][64];
  double m1_buf_0[8][64];
  double prod_buf_0[8][64];
  int mars_count_0_1 = 0;
  double mars_kernel_0_1_m1_buf_0_0[8][64];
...
#pragma HLS array_partition variable=mars_kernel_0_1_m1_buf_0_0 complete dim=2
  double mars_kernel_0_1_m1_buf_0_1[8][64];
...
#pragma HLS array_partition variable=mars_kernel_0_1_m1_buf_0_1 complete dim=2
  double mars_kernel_0_1_m1_buf_0_2[8][64];
...
#pragma HLS array_partition variable=mars_kernel_0_1_m2_buf_0_2 complete dim=1
  double mars_kernel_0_1_prod_buf_0_0[8][64];
...
#pragma HLS array_partition variable=mars_kernel_0_1_prod_buf_0_0 complete dim=2
  double mars_kernel_0_1_prod_buf_0_1[8][64];
...
#pragma HLS array_partition variable=mars_kernel_0_1_prod_buf_0_1 complete dim=2
  double mars_kernel_0_1_prod_buf_0_2[8][64];
...
{
    if (mars_count_0_1 == 0) 
      mars_kernel_0_1(i,0,7,&i_col,&k_col,m1,mars_kernel_0_1_m1_buf_0_0,mars_kernel_0_1_m1_buf_0_1,m2,mars_kernel_0_1_m2_buf_0_0,mars_kernel_0_1_m2_buf_0_1,&mult,prod,mars_kernel_0_1_prod_buf_0_0,mars_kernel_0_1_prod_buf_0_1);
     else if (mars_count_0_1 == 1) 
      mars_kernel_0_1(i,0,7,&i_col,&k_col,m1,mars_kernel_0_1_m1_buf_0_2,mars_kernel_0_1_m1_buf_0_0,m2,mars_kernel_0_1_m2_buf_0_2,mars_kernel_0_1_m2_buf_0_0,&mult,prod,mars_kernel_0_1_prod_buf_0_2,mars_kernel_0_1_prod_buf_0_0);
     else 
      mars_kernel_0_1(i,0,7,&i_col,&k_col,m1,mars_kernel_0_1_m1_buf_0_1,mars_kernel_0_1_m1_buf_0_2,m2,mars_kernel_0_1_m2_buf_0_1,mars_kernel_0_1_m2_buf_0_2,&mult,prod,mars_kernel_0_1_prod_buf_0_1,mars_kernel_0_1_prod_buf_0_2);
    mars_count_0_1++;
    if (mars_count_0_1 == 3) 
      mars_count_0_1 = 0;
  }
