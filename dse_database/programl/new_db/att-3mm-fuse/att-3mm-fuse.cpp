...
#pragma ACCEL PARALLEL reduction=Q FACTOR=auto{__PARA__L4} 
      for (int k = 0; k < 768; ++k) {
...
#pragma ACCEL PARALLEL reduction=K FACTOR=auto{__PARA__L5}
      for (int k = 0; k < 768; ++k) {
...
#pragma ACCEL PARALLEL reduction=atten FACTOR=auto{__PARA__L6}
      for (int k = 0; k < 64; ++k) {
