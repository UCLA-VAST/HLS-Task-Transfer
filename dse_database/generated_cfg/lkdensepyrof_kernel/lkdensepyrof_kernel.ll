; ModuleID = '/home/vagrant/software-gnn/dse_database/ast_kernels/lkdensepyrof_kernel.cpp'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%class.ap_uint = type { [4 x i8] }
...
define void @_Z14pyr_down_accelP7ap_uintILi32EES1_iiii(%class.ap_uint* %img_inp, %class.ap_uint* %img_out, i32 %in_rows, i32 %in_cols, i32 %out_rows, i32 %out_cols) uwtable {
  ...
  call void @_ZL93p_ZN2xf11Array2xfMatILi32ELi0ELi256ELi256ELi1EEEP7ap_uintILi32EER3MatILi0ELi256ELi256ELi1EE_1P7ap_uintILi32EER19xf_Mat_0_256_256_1_(%class.ap_uint* %15, %struct.xf_Mat_0_256_256_1_* %in_mat)
  ...
  call void @_ZL93p_ZN2xf11xfMat2ArrayILi32ELi0ELi256ELi256ELi1EEER3MatILi0ELi256ELi256ELi1EEP7ap_uintILi32EE_1R19xf_Mat_0_256_256_1_P7ap_uintILi32EE(%struct.xf_Mat_0_256_256_1_* %out_mat, %class.ap_uint* %16)
  ret void
}
...
define internal void @_ZL93p_ZN2xf11Array2xfMatILi32ELi0ELi256ELi256ELi1EEEP7ap_uintILi32EER3MatILi0ELi256ELi256ELi1EE_1P7ap_uintILi32EER19xf_Mat_0_256_256_1_(%class.ap_uint* %srcPtr, %struct.xf_Mat_0_256_256_1_* %dstMat) uwtable {
  %1 = alloca %class.ap_uint*, align 8
  ...
  call void @_ZL106p_ZN2xf11accel_utils11Array2xfMatILi32ELi0ELi256ELi256ELi1EEEP7ap_uintILi32EER3MatILi0ELi256ELi256ELi1EE_1P14xf_accel_utilsP7ap_uintILi32EER19xf_Mat_0_256_256_1_(%struct.xf_accel_utils* %au, %class.ap_uint* %3, %struct.xf_Mat_0_256_256_1_* %4)
  ret void
}
...
define internal void @_ZL93p_ZN2xf11xfMat2ArrayILi32ELi0ELi256ELi256ELi1EEER3MatILi0ELi256ELi256ELi1EEP7ap_uintILi32EE_1R19xf_Mat_0_256_256_1_P7ap_uintILi32EE(%struct.xf_Mat_0_256_256_1_* %srcMat, %class.ap_uint* %dstPtr) uwtable {
  %1 = alloca %struct.xf_Mat_0_256_256_1_*, align 8
  %2 = alloca %class.ap_uint*, align 8
  %au = alloca %struct.xf_accel_utils, align 1
  ...
  call void @_ZL106p_ZN2xf11accel_utils11xfMat2ArrayILi32ELi0ELi256ELi256ELi1EEER3MatILi0ELi256ELi256ELi1EEP7ap_uintILi32EE_1P14xf_accel_utilsR19xf_Mat_0_256_256_1_P7ap_uintILi32EE(%struct.xf_accel_utils* %au, %struct.xf_Mat_0_256_256_1_* %3, %class.ap_uint* %4)
  ret void
}

define internal void @_ZL106p_ZN2xf11accel_utils11xfMat2ArrayILi32ELi0ELi256ELi256ELi1EEER3MatILi0ELi256ELi256ELi1EEP7ap_uintILi32EE_1P14xf_accel_utilsR19xf_Mat_0_256_256_1_P7ap_uintILi32EE(%struct.xf_accel_utils* %this_, %struct.xf_Mat_0_256_256_1_* %srcMat, %class.ap_uint* %dstPtr) uwtable {
  ...
  call void @_ZL125p_ZN2xf11accel_utils13xfMat2hlsStrmILi32ELi0ELi256ELi256ELi1ELi65536EEER3MatILi0ELi256ELi256ELi1EER6streamI7ap_uintILi32EEE_1P14xf_accel_utilsR19xf_Mat_0_256_256_1_RN3hls6streamI7ap_uintILi32EEEE(%struct.xf_accel_utils* %10, %struct.xf_Mat_0_256_256_1_* %11, %"class.hls::stream"* %strm)
  %12 = load %struct.xf_accel_utils** %1, align 8
  %13 = load %class.ap_uint** %3, align 8
  %14 = load i32* %rows, align 4
  %15 = load i32* %cols, align 4
  call void @_ZL120p_ZN2xf11accel_utils13hlsStrm2ArrayILi32ELi256ELi256ELi1ELi1ELi8ELi16384EEER6streamI7ap_uintILi32EEEP7ap_uintILi32EEii_1P14xf_accel_utilsRN3hls6streamI7ap_uintILi32EEEEPS4_ii(%struct.xf_accel_utils* %12, %"class.hls::stream"* %strm, %class.ap_uint* %13, i32 %14, i32 %15)
  ret void
}

declare void @_ZN3hls6streamI7ap_uintILi32EEEC1Ev(%"class.hls::stream"*)

define internal void @_ZL125p_ZN2xf11accel_utils13xfMat2hlsStrmILi32ELi0ELi256ELi256ELi1ELi65536EEER3MatILi0ELi256ELi256ELi1EER6streamI7ap_uintILi32EEE_1P14xf_accel_utilsR19xf_Mat_0_256_256_1_RN3hls6streamI7ap_uintILi32EEEE(%struct.xf_accel_utils* %this_, %struct.xf_Mat_0_256_256_1_* %srcMat, %"class.hls::stream"* %dstStrm) uwtable {
  %1 = alloca %struct.xf_accel_utils*, align 8
  %2 = alloca %struct.xf_Mat_0_256_256_1_*, align 8
  ...
  call void @_ZN7ap_uintILi32EEC1Ev(%class.ap_uint* %r)
...
; <label>:29                                      ; preds = %20
  ...
  %36 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %r, i32 31, i32 %35)
  store i64 %33, i64* %36
  %37 = load %"class.hls::stream"** %3, align 8
  call void @_ZN3hls6streamI7ap_uintILi32EEE5writeERKS2_(%"class.hls::stream"* %37, %class.ap_uint* %r)
...
; <label>:40                                      ; preds = %29
  ...
  %45 = sub nsw i32 8, %44
  %46 = sub nsw i32 %45, 1
  %47 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %r, i32 %46, i32 0)
  store i64 %43, i64* %47
  br label %48
...
; <label>:52                                      ; preds = %20
  ...
  %60 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %r, i32 %57, i32 %59)
  store i64 %53, i64* %60
...
; <label>:70                                      ; preds = %67
  ...
  call void @_ZN3hls6streamI7ap_uintILi32EEE5writeERKS2_(%"class.hls::stream"* %71, %class.ap_uint* %r)
  br label %72
...
define internal void @_ZL120p_ZN2xf11accel_utils13hlsStrm2ArrayILi32ELi256ELi256ELi1ELi1ELi8ELi16384EEER6streamI7ap_uintILi32EEEP7ap_uintILi32EEii_1P14xf_accel_utilsRN3hls6streamI7ap_uintILi32EEEEPS4_ii(%struct.xf_accel_utils* %this_, %"class.hls::stream"* %srcStrm, %class.ap_uint* %dstPtr, i32 %rows, i32 %cols) uwtable {
  %1 = alloca %struct.xf_accel_utils*, align 8
...
; <label>:19                                      ; preds = %15
  ...
  %28 = call %class.ap_uint* @_ZN7ap_uintILi32EEaSERKS0_(%class.ap_uint* %23, %class.ap_uint* %6)
  br label %29
...
declare %class.ap_uint* @_ZN7ap_uintILi32EEaSERKS0_(%class.ap_uint*, %class.ap_uint*)

declare i32 @_ZN3hls6streamI7ap_uintILi32EEE4readEv(%"class.hls::stream"*)

declare void @_ZN7ap_uintILi32EEC1Ev(%class.ap_uint*)
...
declare i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint*, i32, i32)

declare void @_ZN3hls6streamI7ap_uintILi32EEE5writeERKS2_(%"class.hls::stream"*, %class.ap_uint*)
...
define internal void @_ZL97p_Z20xFPyrDownApplykernelILi1ELi0ELi5ELi25ELi1EEP7ap_uintILi8EEPA5_7ap_uintILi8EE7ap_uintILi8EE_1P7ap_uintILi8EEPA5_S0_S0_(%class.ap_uint.0* %OutputValues, [5 x %class.ap_uint.0]* %src_buf, i8 %win_size.coerce) uwtable {
  ...
  %7 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i32 0
  %8 = getelementptr inbounds %class.ap_uint* %7, i64 25
  br label %9

; <label>:9                                       ; preds = %9, %0
  %10 = phi %class.ap_uint* [ %7, %0 ], [ %11, %9 ]
  call void @_ZN7ap_uintILi32EEC1Ev(%class.ap_uint* %10)
  %11 = getelementptr inbounds %class.ap_uint* %10, i64 1
  %12 = icmp eq %class.ap_uint* %11, %8
...
; <label>:22                                      ; preds = %19
  ...
  %25 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 %24
  ...
  %33 = call %class.ap_uint* @_ZN7ap_uintILi32EEaSILi8EEERS0_RKS_IXT_EE(%class.ap_uint* %25, %class.ap_uint.0* %32)
...
; <label>:43                                      ; preds = %15
  call void @_ZN7ap_uintILi32EEC1Ei(%class.ap_uint* %out_pixel, i32 0)
...
; <label>:48                                      ; preds = %45
  %49 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 0
  %50 = load i32* %_l_k, align 4
  %51 = add nsw i32 %50, 7
  %52 = load i32* %_l_k, align 4
  %53 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %49, i32 %51, i32 %52)
  %54 = load i64* %53
  %55 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 4
  %56 = load i32* %_l_k, align 4
  %57 = add nsw i32 %56, 7
  %58 = load i32* %_l_k, align 4
  %59 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %55, i32 %57, i32 %58)
  %60 = load i64* %59
  %61 = add i64 %54, %60
  %62 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 20
  %63 = load i32* %_l_k, align 4
  %64 = add nsw i32 %63, 7
  %65 = load i32* %_l_k, align 4
  %66 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %62, i32 %64, i32 %65)
  %67 = load i64* %66
  %68 = add i64 %61, %67
  %69 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 24
  %70 = load i32* %_l_k, align 4
  %71 = add nsw i32 %70, 7
  %72 = load i32* %_l_k, align 4
  %73 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %69, i32 %71, i32 %72)
  %74 = load i64* %73
  %75 = add i64 %68, %74
  %76 = call %class.ap_uint* @_ZN7ap_uintILi32EEaSEm(%class.ap_uint* %out_pixel, i64 %75)
  %77 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 1
  %78 = load i32* %_l_k, align 4
  %79 = add nsw i32 %78, 7
  %80 = load i32* %_l_k, align 4
  %81 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %77, i32 %79, i32 %80)
  %82 = load i64* %81
  %83 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 3
  %84 = load i32* %_l_k, align 4
  %85 = add nsw i32 %84, 7
  %86 = load i32* %_l_k, align 4
  %87 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %83, i32 %85, i32 %86)
  %88 = load i64* %87
  %89 = add i64 %82, %88
  %90 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 5
  %91 = load i32* %_l_k, align 4
  %92 = add nsw i32 %91, 7
  %93 = load i32* %_l_k, align 4
  %94 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %90, i32 %92, i32 %93)
  %95 = load i64* %94
  %96 = add i64 %89, %95
  %97 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 9
  %98 = load i32* %_l_k, align 4
  %99 = add nsw i32 %98, 7
  %100 = load i32* %_l_k, align 4
  %101 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %97, i32 %99, i32 %100)
  %102 = load i64* %101
  %103 = add i64 %96, %102
  %104 = shl i64 %103, 2
  %105 = call %class.ap_uint* @_ZpLILi32EER7ap_uintIXT_EES2_m(%class.ap_uint* %out_pixel, i64 %104)
  %106 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 21
  %107 = load i32* %_l_k, align 4
  %108 = add nsw i32 %107, 7
  %109 = load i32* %_l_k, align 4
  %110 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %106, i32 %108, i32 %109)
  %111 = load i64* %110
  %112 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 23
  %113 = load i32* %_l_k, align 4
  %114 = add nsw i32 %113, 7
  %115 = load i32* %_l_k, align 4
  %116 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %112, i32 %114, i32 %115)
  %117 = load i64* %116
  %118 = add i64 %111, %117
  %119 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 15
  %120 = load i32* %_l_k, align 4
  %121 = add nsw i32 %120, 7
  %122 = load i32* %_l_k, align 4
  %123 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %119, i32 %121, i32 %122)
  %124 = load i64* %123
  %125 = add i64 %118, %124
  %126 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 19
  %127 = load i32* %_l_k, align 4
  %128 = add nsw i32 %127, 7
  %129 = load i32* %_l_k, align 4
  %130 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %126, i32 %128, i32 %129)
  %131 = load i64* %130
  %132 = add i64 %125, %131
  %133 = shl i64 %132, 2
  %134 = call %class.ap_uint* @_ZpLILi32EER7ap_uintIXT_EES2_m(%class.ap_uint* %out_pixel, i64 %133)
  %135 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 2
  %136 = load i32* %_l_k, align 4
  %137 = add nsw i32 %136, 7
  %138 = load i32* %_l_k, align 4
  %139 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %135, i32 %137, i32 %138)
  %140 = load i64* %139
  %141 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 10
  %142 = load i32* %_l_k, align 4
  %143 = add nsw i32 %142, 7
  %144 = load i32* %_l_k, align 4
  %145 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %141, i32 %143, i32 %144)
  %146 = load i64* %145
  %147 = add i64 %140, %146
  %148 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 14
  %149 = load i32* %_l_k, align 4
  %150 = add nsw i32 %149, 7
  %151 = load i32* %_l_k, align 4
  %152 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %148, i32 %150, i32 %151)
  %153 = load i64* %152
  %154 = add i64 %147, %153
  %155 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 22
  %156 = load i32* %_l_k, align 4
  %157 = add nsw i32 %156, 7
  %158 = load i32* %_l_k, align 4
  %159 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %155, i32 %157, i32 %158)
  %160 = load i64* %159
  %161 = add i64 %154, %160
  %162 = shl i64 %161, 2
  %163 = call %class.ap_uint* @_ZpLILi32EER7ap_uintIXT_EES2_m(%class.ap_uint* %out_pixel, i64 %162)
  %164 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 2
  %165 = load i32* %_l_k, align 4
  %166 = add nsw i32 %165, 7
  %167 = load i32* %_l_k, align 4
  %168 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %164, i32 %166, i32 %167)
  %169 = load i64* %168
  %170 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 10
  %171 = load i32* %_l_k, align 4
  %172 = add nsw i32 %171, 7
  %173 = load i32* %_l_k, align 4
  %174 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %170, i32 %172, i32 %173)
  %175 = load i64* %174
  %176 = add i64 %169, %175
  %177 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 14
  %178 = load i32* %_l_k, align 4
  %179 = add nsw i32 %178, 7
  %180 = load i32* %_l_k, align 4
  %181 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %177, i32 %179, i32 %180)
  %182 = load i64* %181
  %183 = add i64 %176, %182
  %184 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 22
  %185 = load i32* %_l_k, align 4
  %186 = add nsw i32 %185, 7
  %187 = load i32* %_l_k, align 4
  %188 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %184, i32 %186, i32 %187)
  %189 = load i64* %188
  %190 = add i64 %183, %189
  %191 = shl i64 %190, 1
  %192 = call %class.ap_uint* @_ZpLILi32EER7ap_uintIXT_EES2_m(%class.ap_uint* %out_pixel, i64 %191)
  %193 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 6
  %194 = load i32* %_l_k, align 4
  %195 = add nsw i32 %194, 7
  %196 = load i32* %_l_k, align 4
  %197 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %193, i32 %195, i32 %196)
  %198 = load i64* %197
  %199 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 8
  %200 = load i32* %_l_k, align 4
  %201 = add nsw i32 %200, 7
  %202 = load i32* %_l_k, align 4
  %203 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %199, i32 %201, i32 %202)
  %204 = load i64* %203
  %205 = add i64 %198, %204
  %206 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 16
  %207 = load i32* %_l_k, align 4
  %208 = add nsw i32 %207, 7
  %209 = load i32* %_l_k, align 4
  %210 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %206, i32 %208, i32 %209)
  %211 = load i64* %210
  %212 = add i64 %205, %211
  %213 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 18
  %214 = load i32* %_l_k, align 4
  %215 = add nsw i32 %214, 7
  %216 = load i32* %_l_k, align 4
  %217 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %213, i32 %215, i32 %216)
  %218 = load i64* %217
  %219 = add i64 %212, %218
  %220 = shl i64 %219, 4
  %221 = call %class.ap_uint* @_ZpLILi32EER7ap_uintIXT_EES2_m(%class.ap_uint* %out_pixel, i64 %220)
  %222 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 7
  %223 = load i32* %_l_k, align 4
  %224 = add nsw i32 %223, 7
  %225 = load i32* %_l_k, align 4
  %226 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %222, i32 %224, i32 %225)
  %227 = load i64* %226
  %228 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 11
  %229 = load i32* %_l_k, align 4
  %230 = add nsw i32 %229, 7
  %231 = load i32* %_l_k, align 4
  %232 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %228, i32 %230, i32 %231)
  %233 = load i64* %232
  %234 = add i64 %227, %233
  %235 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 13
  %236 = load i32* %_l_k, align 4
  %237 = add nsw i32 %236, 7
  %238 = load i32* %_l_k, align 4
  %239 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %235, i32 %237, i32 %238)
  %240 = load i64* %239
  %241 = add i64 %234, %240
  %242 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 17
  %243 = load i32* %_l_k, align 4
  %244 = add nsw i32 %243, 7
  %245 = load i32* %_l_k, align 4
  %246 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %242, i32 %244, i32 %245)
  %247 = load i64* %246
  %248 = add i64 %241, %247
  %249 = shl i64 %248, 4
  %250 = call %class.ap_uint* @_ZpLILi32EER7ap_uintIXT_EES2_m(%class.ap_uint* %out_pixel, i64 %249)
  %251 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 7
  %252 = load i32* %_l_k, align 4
  %253 = add nsw i32 %252, 7
  %254 = load i32* %_l_k, align 4
  %255 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %251, i32 %253, i32 %254)
  %256 = load i64* %255
  %257 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 11
  %258 = load i32* %_l_k, align 4
  %259 = add nsw i32 %258, 7
  %260 = load i32* %_l_k, align 4
  %261 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %257, i32 %259, i32 %260)
  %262 = load i64* %261
  %263 = add i64 %256, %262
  %264 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 13
  %265 = load i32* %_l_k, align 4
  %266 = add nsw i32 %265, 7
  %267 = load i32* %_l_k, align 4
  %268 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %264, i32 %266, i32 %267)
  %269 = load i64* %268
  %270 = add i64 %263, %269
  %271 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 17
  %272 = load i32* %_l_k, align 4
  %273 = add nsw i32 %272, 7
  %274 = load i32* %_l_k, align 4
  %275 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %271, i32 %273, i32 %274)
  %276 = load i64* %275
  %277 = add i64 %270, %276
  %278 = shl i64 %277, 3
  %279 = call %class.ap_uint* @_ZpLILi32EER7ap_uintIXT_EES2_m(%class.ap_uint* %out_pixel, i64 %278)
  %280 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 12
  %281 = load i32* %_l_k, align 4
  %282 = add nsw i32 %281, 7
  %283 = load i32* %_l_k, align 4
  %284 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %280, i32 %282, i32 %283)
  %285 = load i64* %284
  %286 = shl i64 %285, 5
  %287 = call %class.ap_uint* @_ZpLILi32EER7ap_uintIXT_EES2_m(%class.ap_uint* %out_pixel, i64 %286)
  %288 = getelementptr inbounds [25 x %class.ap_uint]* %array, i32 0, i64 12
  %289 = load i32* %_l_k, align 4
  %290 = add nsw i32 %289, 7
  %291 = load i32* %_l_k, align 4
  %292 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %288, i32 %290, i32 %291)
  %293 = load i64* %292
  %294 = shl i64 %293, 2
  %295 = call %class.ap_uint* @_ZpLILi32EER7ap_uintIXT_EES2_m(%class.ap_uint* %out_pixel, i64 %294)
  %296 = call i32 @_ZplILi32EE7ap_uintIXT_EERKS1_i(%class.ap_uint* %out_pixel, i32 128)
  %297 = getelementptr %class.ap_uint* %3, i32 0, i32 0
  %298 = bitcast [4 x i8]* %297 to i32*
  store i32 %296, i32* %298, align 1
  %299 = getelementptr %class.ap_uint* %3, i32 0, i32 0
  %300 = bitcast [4 x i8]* %299 to i32*
  %301 = load i32* %300, align 1
  %302 = call i32 @_ZrsILi32EE7ap_uintIXT_EES1_i(i32 %301, i32 8)
  %303 = getelementptr %class.ap_uint* %4, i32 0, i32 0
  %304 = bitcast [4 x i8]* %303 to i32*
  store i32 %302, i32* %304, align 1
  %305 = call i64 @_ZNK7ap_uintILi32EEcvmEv(%class.ap_uint* %4)
...
declare %class.ap_uint* @_ZN7ap_uintILi32EEaSILi8EEERS0_RKS_IXT_EE(%class.ap_uint*, %class.ap_uint.0*)

declare void @_ZN7ap_uintILi32EEC1Ei(%class.ap_uint*, i32)

declare %class.ap_uint* @_ZN7ap_uintILi32EEaSEm(%class.ap_uint*, i64)

declare %class.ap_uint* @_ZpLILi32EER7ap_uintIXT_EES2_m(%class.ap_uint*, i64)

declare i32 @_ZrsILi32EE7ap_uintIXT_EES1_i(i32, i32)

declare i32 @_ZplILi32EE7ap_uintIXT_EERKS1_i(%class.ap_uint*, i32)

declare i64 @_ZNK7ap_uintILi32EEcvmEv(%class.ap_uint*)

define internal void @_ZL106p_ZN2xf11accel_utils11Array2xfMatILi32ELi0ELi256ELi256ELi1EEEP7ap_uintILi32EER3MatILi0ELi256ELi256ELi1EE_1P14xf_accel_utilsP7ap_uintILi32EER19xf_Mat_0_256_256_1_(%struct.xf_accel_utils* %this_, %class.ap_uint* %srcPtr, %struct.xf_Mat_0_256_256_1_* %dstMat) uwtable {
  %1 = alloca %struct.xf_accel_utils*, align 8
  %2 = alloca %class.ap_uint*, align 8
  ...
  call void @_ZL120p_ZN2xf11accel_utils13Array2hlsStrmILi32ELi256ELi256ELi1ELi1ELi8ELi16384EEEP7ap_uintILi32EER6streamI7ap_uintILi32EEEii_1P14xf_accel_utilsP7ap_uintILi32EERN3hls6streamIS2_EEii(%struct.xf_accel_utils* %10, %class.ap_uint* %11, %"class.hls::stream"* %strm, i32 %12, i32 %13)
  %14 = load %struct.xf_accel_utils** %1, align 8
  %15 = load %struct.xf_Mat_0_256_256_1_** %3, align 8
  call void @_ZL125p_ZN2xf11accel_utils13hlsStrm2xfMatILi32ELi0ELi256ELi256ELi1ELi65536EEER6streamI7ap_uintILi32EEER3MatILi0ELi256ELi256ELi1EE_1P14xf_accel_utilsRN3hls6streamI7ap_uintILi32EEEER19xf_Mat_0_256_256_1_(%struct.xf_accel_utils* %14, %"class.hls::stream"* %strm, %struct.xf_Mat_0_256_256_1_* %15)
  ret void
}

define internal void @_ZL120p_ZN2xf11accel_utils13Array2hlsStrmILi32ELi256ELi256ELi1ELi1ELi8ELi16384EEEP7ap_uintILi32EER6streamI7ap_uintILi32EEEii_1P14xf_accel_utilsP7ap_uintILi32EERN3hls6streamIS2_EEii(%struct.xf_accel_utils* %this_, %class.ap_uint* %srcPtr, %"class.hls::stream"* %dstStrm, i32 %rows, i32 %cols) uwtable {
  %1 = alloca %struct.xf_accel_utils*, align 8
  %2 = alloca %class.ap_uint*, align 8
  %3 = alloca %"class.hls::stream"*, align 8
  %4 = alloca i32, align 4
...
; <label>:18                                      ; preds = %14
  ...
  %23 = getelementptr inbounds %class.ap_uint* %22, i64 %21
  call void @_ZN3hls6streamI7ap_uintILi32EEE5writeERKS2_(%"class.hls::stream"* %19, %class.ap_uint* %23)
  br label %24
...
define internal void @_ZL125p_ZN2xf11accel_utils13hlsStrm2xfMatILi32ELi0ELi256ELi256ELi1ELi65536EEER6streamI7ap_uintILi32EEER3MatILi0ELi256ELi256ELi1EE_1P14xf_accel_utilsRN3hls6streamI7ap_uintILi32EEEER19xf_Mat_0_256_256_1_(%struct.xf_accel_utils* %this_, %"class.hls::stream"* %srcStrm, %struct.xf_Mat_0_256_256_1_* %dstMat) uwtable {
  %1 = alloca %struct.xf_accel_utils*, align 8
  %2 = alloca %"class.hls::stream"*, align 8
  %3 = alloca %struct.xf_Mat_0_256_256_1_*, align 8
  %rows = alloca i32, align 4
...
; <label>:27                                      ; preds = %24
  ...
  %30 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %r, i32 31, i32 %29)
  %31 = load i64* %30
...
; <label>:35                                      ; preds = %27, %24
  ...
  %37 = call i32 @_ZN3hls6streamI7ap_uintILi32EEE4readEv(%"class.hls::stream"* %36)
  %38 = getelementptr %class.ap_uint* %4, i32 0, i32 0
  %39 = bitcast [4 x i8]* %38 to i32*
  store i32 %37, i32* %39, align 1
  %40 = call %class.ap_uint* @_ZN7ap_uintILi32EEaSERKS0_(%class.ap_uint* %r, %class.ap_uint* %4)
  %41 = load i32* %valid_bits, align 4
  %42 = sub nsw i32 8, %41
  %43 = sub nsw i32 %42, 1
  %44 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %r, i32 %43, i32 0)
  %45 = load i64* %44
...
; <label>:51                                      ; preds = %21
  ...
  %58 = call i64* @_ZN7ap_uintILi32EE5rangeEii(%class.ap_uint* %r, i32 %55, i32 %57)
  %59 = load i64* %58
